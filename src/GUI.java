...
public class GUI extends JFrame
{
	...
	final JButton addFileButton = new JButton("Add file(s) to be zipped.");
	...
	final JButton clearFilesButton = new JButton("Clear file(s)");
	...
	*/
        ...
        add(panel);
	pack();
	setTitle("Zipping Magic by Pranav Jain");
